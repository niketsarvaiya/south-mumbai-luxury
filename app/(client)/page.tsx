      ...
      <section className="py-12 px-6 bg-champagne">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 shrink-0">
            <a href="tel:+919820011234" className="flex items-center gap-2 bg-obsidian text-white text-xs font-sans tracking-widest uppercase px-6 py-3 hover:bg-navy transition-colors">
              <Phone size={14} />
              Call Now
            </a>
            <Link href="/properties">
