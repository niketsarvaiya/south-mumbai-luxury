      ...
      <section className="bg-white border-b border-warm-grey-100 px-6 py-6 sticky top-20 z-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a
              href={`https://wa.me/919987310760?text=I'm interested in ${property.buildingName}`}
              target="_blank"
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-5">
            ...
            {/* WhatsApp */}
            <a
              href={`https://wa.me/919987310760?text=Hi, I'm interested in ${property.buildingName} (${property.id})`}
              target="_blank"
              rel="noopener noreferrer"
